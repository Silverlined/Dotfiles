...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'which-key.nvim', 'dashboard-nvim', 'barbar.nvim', 'galaxyline.nvim', 'FTerm.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
