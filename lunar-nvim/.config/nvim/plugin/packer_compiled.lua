...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'FTerm.nvim', 'dashboard-nvim', 'which-key.nvim', 'galaxyline.nvim', 'barbar.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
